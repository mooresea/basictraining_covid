...
load(file="../output/forecasted_infection_estimates_hiasymp.rda")
...
ggsave("../figures/observation_correlations.pdf",plot_corr2,width=8,height=5,pointsize=14,units="in")
...
pdf(file="../figures/positives_on_arrival_forecast_ribbon3.pdf",width=8,height=6,pointsize=14)
plotA
dev.off()

pdf(file="../figures/positives_in_quarantine_MLE_forecast_ribbon3.pdf",width=8,height=6,pointsize=14)
plotQ
dev.off()
pdf(file="../figures/positives_during_training_MLE_forecast_ribbon3.pdf",width=8,height=6,pointsize=14)
plotT
dev.off()

pdf(file="../figures/positives_during_training_noforecast.pdf",width=8,height=6,pointsize=14)
plotT2
dev.off()

pdf(file="../figures/positives_during_All_training_MLE_forecast_ribbon3.pdf",width=8,height=6,pointsize=14)
plotQT
dev.off()
...
ggsave("../figures/combo_infections_plot_ribbon3.pdf",plotC,width=8,height=14,pointsize=14,units="in")
...
ggsave("../figures/combo_infections_imports_plot_ribbon3.pdf",plotC4,width=14,height=10,pointsize=14,units="in")
...
ggsave("../figures/combo_positives_imports_plot_2panel.pdf",plotCC,width=8.5,height=8.5/1.4,pointsize=14,units="in")
ggsave("../figures/combo_arrivals_camp.pdf",plotC1,width=8,height=10,pointsize=14,units="in")
ggsave("../figures/combo_arrivals_camp_imports.pdf",plotC1_alt,width=8,height=15,pointsize=14,units="in")
...
ggsave("../figures/combo_infections_imports_plot_ribbon3_alt.pdf",plotCAlt,width=8,height=14,pointsize=14,units="in")
...
##Quarantine
pdf(file="../figures/arrival_testing_impact_quarantine.pdf",width=8,height=6,pointsize=14)
...
##Training
pdf(file="../figures/quarantine_testing_impact_training.pdf",width=8,height=6,pointsize=14)
...
plot_stp<-ggplot(combo_sum_test[combo_sum_test$testing %in% c("Quarantine","Both","Arrival","None"),],aes(x=Start_date,y=(total_sympI_median)/Total_size,color=testing))+geom_line(lwd=2)+theme_bw()+
  ...
  scale_fill_manual(name="Surveillance\nTesting",breaks=c("Arrival","Quarantine","Both","None"),c("Arrival","Cocoon","Both","None"),values=testing_colors[c(2,3,4,1)])+
  scale_color_manual(name="Surveillance\nTesting",breaks=c("Arrival","Quarantine","Both","None"),labels=c("Arrival","Cocoon","Both","None"),values=testing_colors[c(2,3,4,1)])
ggsave("../figures/surveillance_testing_symp.pdf",plot_stp,width=6,height=4,pointsize=14,units="in")

plotC_st<-plot_grid(plot_at,plot_sti,plot_att,plot_qt,ncol=2,labels="AUTO")

ggsave("../figures/combo_surveillance_testing_impact.pdf",plotC_st,width=14,height=10,pointsize=14,units="in")
...
ggsave("../figures/combo_surveillance_testing_impact_2panel.pdf",plotC_st_b,width=8.5,height=8/1.4,pointsize=14,units="in")
...
pdf(file="../figures/masks_impact_infections.pdf",width=8,height=6,pointsize=14)
...
plot_mi
dev.off()
pdf(file="../figures/masks_impact_symp_infections.pdf",width=8,height=6,pointsize=14)
...
pdf(file="../figures/intervention_impact_infections.pdf",width=8,height=6,pointsize=14)
...
pdf(file="../figures/vaccine_impact_infections.pdf",width=8,height=6,pointsize=14)
...
pdf(file="../figures/vaccine_impact_symptomatic_infections.pdf",width=8,height=6,pointsize=14)
...
ggsave("../figures/combo_mask_vaccine_impact_symptomatic.pdf",plotC_vm,width=8,height=5,pointsize=14,units="in")

##
## Vaccinating Staff
##
pdf(file="../figures/vaccine_staff_impact_infections.pdf",width=8,height=6,pointsize=14)
...
pdf(file="../figures/vaccine_staff_impact_symptomatic_infections.pdf",width=8,height=6,pointsize=14)
...
pdf(file="../figures/vaccine_staff_impact_importations.pdf",width=8,height=6,pointsize=14)
...
#ggsave("../figures/combo_mask_vaccine_impact.pdf",plotC_vm,width=14,height=6,pointsize=14,units="in")
ggsave("../figures/combo_mask_vaccine_impact_staff.pdf",plotC_vm2,width=14,height=10,pointsize=14,units="in")
...
ggsave("../figures/infections_by_arrival_import_violin.pdf",plot_pct_imp_viol,width=4.5,height=7,pointsize=14,units="in")

plot_pct_imp_poster<-plot_grid(plot_pct_t,plot_imp_t,ncol=2,labels="AUTO")

ggsave("../figures/infections_by_arrival_import_poster.pdf",plot_pct_imp_poster,width=12,height=6,pointsize=14,units="in")
...
ggsave("../figures/infections_by_arrival_import_waves.pdf",plot_pct_imp_date,width=14,height=6,pointsize=14,units="in")
...
ggsave("../figures/infections_by_R0.pdf",plot_R0,width=8,height=3,pointsize=14,units="in")


plot_R0_vert<-plot_grid(plot_Inf_R0,plot_Inf_Imp_R0,ncol=1,labels="AUTO")

ggsave("../figures/infections_by_R0_vertical.pdf",plot_R0_vert,width=4.5,height=6,pointsize=14,units="in")
...
ggsave("../figures/interventions_impact_post-vaccination_summary.pdf",plot_impact_sum,width=6,height=4,pointsize=14,units="in")
...
ggsave("../figures/interventions_impact_post-vaccination_summary_alt.pdf",plot_impact_sum_alt,width=6,height=4,pointsize=14,units="in")
...
ggsave("../figures/interventions_impact_post-vaccination_summary_poster.pdf",plot_impact_sum_poster,width=6,height=4,pointsize=14,units="in")
...
ggsave("../figures/interventions_impact_post-vaccination_imports.pdf",plot_int_imp,width=6,height=4,pointsize=14,units="in")
...
ggsave("../figures/interventions_impact_post-vaccination_imports_poster.pdf",plot_int_imp_poster,width=6,height=4,pointsize=14,units="in")

# plot_pct_inter<-plot_grid(plot_int_arr,plot_int_imp,ncol=1,labels="AUTO")
# 
# ggsave("../figures/interventions_impact_post-vaccination_by_arrival_import.pdf",plot_pct_inter,width=8,height=10,pointsize=14,units="in")
...
ggsave("../figures/interventions_impact_post-vaccination_by_arrival_import_UPD.pdf",plot_pct_inter,width=6,height=7.5,pointsize=14,units="in")
...
ggsave("../figures/infections_by_arrival_import_impact.pdf",plot_intervention,width=8,height=14,pointsize=14,units="in")
...
ggsave("../figures/interventions_impact_post-vaccination_update.pdf",plot_int_sum,width=6,height=4,pointsize=14,units="in")
...
ggsave("../figures/interventions_impact_post-vaccination_summary.pdf",plot_int_sum2,width=6,height=4,pointsize=14,units="in")
...
pdf(file="../figures/masking_impact_by_imports.pdf",width=8,height=6,pointsize=14)
